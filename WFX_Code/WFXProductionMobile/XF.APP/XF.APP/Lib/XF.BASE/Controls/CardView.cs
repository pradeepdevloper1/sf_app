...
namespace XF.BASE
{
    public class CardView : ContentView
    {
        ...
        public CardView()
        {
            ...
            CardViewVerticalOptionsProperty = BindableProperty.Create(
               propertyName: "CardViewVerticalOptions",
               returnType: typeof(LayoutOptions),
               declaringType: typeof(CardView),
               defaultValue: LayoutOptions.Start,
               propertyChanged: CardViewVerticalOptionsChanged);
            ...
            _innerFrame = new Frame
            {
                ...
                VerticalOptions = CardViewVerticalOptions,
                CornerRadius = 5
            };
        ...
        public readonly BindableProperty CardViewVerticalOptionsProperty;
        ...
        public LayoutOptions CardViewVerticalOptions
        {
            get
            {
                return (LayoutOptions)GetValue(CardViewVerticalOptionsProperty);
            }
            set
            {
                SetValue(CardViewVerticalOptionsProperty, value);
            }
        }
        ...
        private static void CardViewVerticalOptionsChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
            CompareOldAndNewValue(oldvalue, newvalue, () => ((CardView)bindable).ChangeVerticalOptionsProperty());
        }
        ...
        private void ChangeVerticalOptionsProperty()
        {
            _innerFrame.VerticalOptions = CardViewVerticalOptions;
        }
