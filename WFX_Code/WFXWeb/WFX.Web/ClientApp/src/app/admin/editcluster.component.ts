...
@Component({
  selector: 'app-admin',
  templateUrl: './editcluster.component.html',
})
export class EditCulsterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.clustername = "";
    this.CulsterService.ClusterView(this.clusterid).subscribe(
      res => {
        this.culstermodel = res;
        console.log(res);
        ...
        this.organisationid = this.culstermodel.organisationID;
        this.clustername = this.culstermodel.clusterName;

         //alert(this.culstermodel.organisationID);
        //alert(this.culstermodel.clusterName);
  ...
  UpdateCulster() {
    ...
    //alert(re);
    /*return;*/
    this.CulsterService.UpdateCulster(this.culstermodel).subscribe(
      res => {
        /*        debugger;*/
        if (res.status == 200) {
          alert("Record save");
